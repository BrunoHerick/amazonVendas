...
dados_previsores[:,0] = encoder_buyer.fit_transform(dados_previsores[:,0])
dados_previsores[:,1] = encoder_ship_city.fit_transform(dados_previsores[:,1])
dados_previsores[:,2] = encoder_ship_state.fit_transform(dados_previsores[:,2])
dados_previsores[:,3] = encoder_sku.fit_transform(dados_previsores[:,3])
dados_previsores[:,4] = encoder_description.fit_transform(dados_previsores[:,4])
dados_previsores[:,5] = encoder_quantity.fit_transform(dados_previsores[:,5])
dados_previsores[:,6] = encoder_item_total.fit_transform(dados_previsores[:,6])
dados_previsores[:,7] = encoder_shipping_fee.fit_transform(dados_previsores[:,7])
dados_previsores[:,8] = encoder_cod.fit_transform(dados_previsores[:,8])
